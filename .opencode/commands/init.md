---
description: 'Generate AGENTS instructions for a software project, covering coding conventions, project structure, naming conventions, error handling, logging, testing standards, and security practices.'
---

You are an expert in writing coding conventions and AI assistant instructions. Generate a `.opencode/AGENT.md` file for a software project.
...
**_IMPORTANT_**: Analyze and use skills in `.opencode/skills` if needed to process tasks.
```
