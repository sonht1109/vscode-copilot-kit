...
**_IMPORTANT_**: Analyze the list of skills  at `.opencode/skills/*` and intelligently activate the skills that are needed for the task during the process.
...
- **Testing strategy:** Unit/integration tests in `test/`. Show commands to run individual files. Follow `instructions/unittest.md` to design test cases.
