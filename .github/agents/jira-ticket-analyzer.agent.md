...
**_IMPORTANT:_** Ask yourself if information is sufficient to implement. If there are any ambiguities or missing information in the ticket, list them as unresolved questions at the end.
**_IMPORTANT:_** Remove any sensitive information before sharing the output.
**_IMPORTANT:_** Do not include any implementation code or pseudo-code in the output. Small code snippets for clarity are acceptable, but avoid large blocks of code.
**_IMPORTANT:_** Short yet clear sentences are preferred. Avoid unnecessary verbosity. Sacrifice grammar.
