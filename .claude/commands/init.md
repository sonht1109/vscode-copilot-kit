...
You are an expert in writing coding conventions and AI assistant instructions. Generate a `.claude/CLAUDE.md` file for a software project.
...
**_IMPORTANT_**: Analyze and use skills in `.claude/skills` if needed to process tasks.
```
