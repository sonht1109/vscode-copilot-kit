...
2. **Clone code changes**: analyze skills in `.claude/skills/clone-code-changes` to stage and clone the code changes from the local repository to a new directory for review.
